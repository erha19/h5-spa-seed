...
;(function($,win){
    ...
    function Slider(option,el){
        ...
        $.extend(this,{
            ...
            autoPlayDuration : option.autoPlayDuration || 4000,
    ...
    Slider.prototype.init = function(){
        var me    = this,
            ...
            nav = $('<div class="nav"><span class="index">1</span>/'+items.length+'</div>')
        this.nav=nav;
        this.wrap = $(wrap);
        this.offset = 0;
        this.index = 0;
        $(me.target).append(this.nav)
        items.wrapAll(wrap);
    ...
    Slider.prototype.goDirection = function(direction,time){
        ...
        this.nav.find('.index').text((this.getNowIndex()+1)?this.getNowIndex()+1:3);
        if(this.index<0){
